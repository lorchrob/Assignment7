  ...
  public ControlPanel(NoteIndices notes, ArrayPanel panel) {
    ...
    playButton.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        final List<SortEvent<Integer>> events = generateEvents((String) sorts.getSelectedItem(), notes.getNotes().clone()); // CLONE THE NOTES ARRAY?
        //events = generateEvents((String) sorts.getSelectedItem(), notes.getNotes()); // CLONE THE NOTES ARRAY?
        
        //events = Sorts.insertionSort(notes);
        ...
        timer.schedule(new TimerTask() {
          ...
          public void run() {
            if (index < events.size()) {
              ...
              for (Integer index: e.getAffectedIndices()) {
